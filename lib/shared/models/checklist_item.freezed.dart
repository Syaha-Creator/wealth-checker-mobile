...
mixin _$ChecklistItem {
 ...
 String get itemKey; bool get isChecked; String get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChecklistItem&&(identical(other.itemKey, itemKey) || other.itemKey == itemKey)&&(identical(other.isChecked, isChecked) || other.isChecked == isChecked)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,itemKey,isChecked,updatedAt);

@override
String toString() {
  return 'ChecklistItem(itemKey: $itemKey, isChecked: $isChecked, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String itemKey, bool isChecked, String updatedAt
});
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? itemKey = null,Object? isChecked = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String itemKey,  bool isChecked,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChecklistItem() when $default != null:
return $default(_that.itemKey,_that.isChecked,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String itemKey,  bool isChecked,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ChecklistItem():
return $default(_that.itemKey,_that.isChecked,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String itemKey,  bool isChecked,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ChecklistItem() when $default != null:
return $default(_that.itemKey,_that.isChecked,_that.updatedAt);case _:
  return null;
...
class _ChecklistItem implements ChecklistItem {
  const _ChecklistItem({required this.itemKey, required this.isChecked, required this.updatedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChecklistItem&&(identical(other.itemKey, itemKey) || other.itemKey == itemKey)&&(identical(other.isChecked, isChecked) || other.isChecked == isChecked)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? itemKey = null,Object? isChecked = null,Object? updatedAt = null,}) {
